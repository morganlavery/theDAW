...
from larsnet.unet import UNetUtils, UNet, UNetWaveform
...
class LarsNet(nn.Module):
    ...
    def __init__(self,
        ...
        # Store the config file path to resolve relative paths
        ...
        for stem in pbar:
            # Resolve model path relative to config file location
            model_path = config['inference_models'][stem]
            checkpoint_path = config_dir / model_path
